...
const badgeVariant = badge.badgeRecipe.variants?.variant;
const tagSlotRecipe = config.defineSlotRecipe({
  slots: anatomy.tagAnatomy.keys(),
...
exports.tagSlotRecipe = tagSlotRecipe;
